...
;(function (root, factory) {
    if (typeof define === "function" && define.amd) {
        ...
        if (typeof jQuery !== "undefined") {
            jQuery.fn.DateTime = jQuery.fn.datetime = function (o) {
                var r = [], i;
                this.each(function () {
                    if ((i = tail.DateTime(this, o)) !== false) {
                        r.push(i);
                    }
                });
        ...
        if (typeof (MooTools) != "undefined") {
            Element.implement({
                DateTime: function (o) {
                    return new tail.DateTime(this, o);
                }
            });
            Element.implement({
                datetime: function (o) {
    ...
    datetime.strings = {
        en: {
            ...
            shorts: ["Dom", "Seg", "Ter", "Qua", "Qui", "Sex", "Sab"],
            time: ["Horas", "Minutos", "Segundos"],
            header: ["selecione um mês", "selecione um ano", "selecione uma decada", "selecione uma hora"]
        },
    ...
    datetime.prototype = {
        ...
        renderTimePicker: function (dt) {
            ...
            for (var key in {Hours: 0, Minutes: 0, Seconds: 0}) {
                ...
                input.setAttribute("value", function (n) {
                    return (n < 10) ? "0" + n : n;
                }(this.view.date["get" + key]()));
