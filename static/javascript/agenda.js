...
function clickEventDetails(calEvent, jsEvent, view) {
    ...
    document.getElementById("viewDocumentos").style.display = "block";
    tarefas.reset()
    contactos.reset();
    ...
    document.getElementById("datainicio").value = dateTemp.getDay().pad(2) + "-" + dateTemp.getMonth().pad(2) + "-" + dateTemp.getFullYear() +
        " " + dateTemp.getHours().pad(2) + ":" + dateTemp.getMinutes().pad(2);

    dateTemp = new Date(agendamento[0].end);
    document.getElementById("datafim").value = dateTemp.getDay().pad(2) + "-" + dateTemp.getMonth().pad(2) + "-" + dateTemp.getFullYear() +
        " " + dateTemp.getHours().pad(2) + ":" + dateTemp.getMinutes().pad(2);
